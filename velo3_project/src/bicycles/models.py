...
def bicycles_picture_directory_path(instance, filename):
...
class Bicycle(models.Model):
    ...
    owner = models.ForeignKey(VeloUser, on_delete=models.CASCADE)
    ...
    release_year = models.IntegerField(max_length=4, blank=True, null=True,
                                       validators=[
    ...
    purchase_year = models.IntegerField(max_length=4, blank=True, null=True,
                                       validators=[
                                           MaxValueValidator(timezone.now().year,
    ...
    pictures = models.ImageField(blank=True, null=True, upload_to=bicycles_picture_directory_path)
