"""
Django settings for velo3_project project.
...
SECRET_KEY = 'django-insecure-&sl!@5%er3)ql%**gbpjwn4dnh0z&9mi&k(@yi32b)tl$up6*^'
...
WSGI_APPLICATION = 'velo3_project.wsgi.application'
...
# когда добавил директорию static
STATICFILES_DIRS = [
